...
public class RSAUtils {
     ...
     * java端加密
     */
    public static String encryptDataOnJavaByPublicKey(String data, String PUBLICKEY) {
        try {
    ...
    public static String encryptDataOnJavaByPrivateKey(String data, String PRIVATEKEY) {
        try {
    ...
    public static String decryptDataOnJavaByPrivateKey(String data, String PRIVATEKEY) throws Exception {
        String temp = "";
//        try {
            byte[] rs = Base64.decodeBase64(data);
